      ...
      <form novalidate @submit.prevent="onLogin">
        <ion-list>
          ...
          <ion-item>
            ...
            <ion-input :value="password" @input="password = $event.target.value" name="password" type="password" required></ion-input>
          </ion-item>
...
export default class Login extends Vue {
  ...
  onLogin(ev: any) {
    ev.preventDefault();
    this.$store.dispatch('user/authentication', {email: this.username, password: this.password})
    .then((response) => {
